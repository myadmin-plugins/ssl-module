...
The class under contract here is `Detain\MyAdminSsl\Plugin`.
...
- This package declares `$module = 'ssl'`. Changing it detaches the plugin from the events core dispatches to it, so the generated pin asserts it.
