...
namespace Detain\MyAdminSsl\Tests\Support {
    /**
...
namespace MyAdmin {
    if (!class_exists(App::class, false)) {
        ...
        class App
        {
            /** @var \Detain\MyAdminSsl\Tests\Support\HistorySpy|null */
            private static $history;

            /**
             * @return \Detain\MyAdminSsl\Tests\Support\HistorySpy
             */
            public static function history()
            {
                if (self::$history === null) {
                    self::$history = new \Detain\MyAdminSsl\Tests\Support\HistorySpy();
                }
                return self::$history;
            }
